...
&emsp;&emsp;香菇之所以能被称为“香”菇，是因为它含有一种独特的风味物质——香菇精。此外，香菇还富含鸟苷酸和独特的香菇多糖，被认为具有调节人体免疫功能的潜力。晒干的香菇不仅风味更浓缩，麦角甾醇转化为维生素D后，营养价值往往比鲜香菇更胜一筹。`,
    ...
    },
    {
        ...
        difficulty: 20,
        intro: `&emsp;&emsp;虫草花，学名 Cordyceps militaris（蛹虫草）。属于真菌界、子囊菌门、肉座菌目、蛹虫草科、虫草属。虽然名字是“虫草话”，但它<b>既不是虫，也不是花</b>，而是一种人工培养的食用真菌。与冬虫夏草不同，它不需要寄生在珍稀的蝙蝠蛾幼虫上，而是像种蘑菇一样，在小麦、大米组成的<b>营养培养基</b>上生长出来。我们吃到的金橙色细长条，实际上是它的子实体（真菌本身）。<br><br>
